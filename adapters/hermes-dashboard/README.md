...
This is a trusted, read-only [Hermes Dashboard plugin](https://hermes-agent.nousresearch.com/docs/user-guide/features/extending-the-dashboard). It renders native Overview, Hotel Rate Finder, and Asia Travel Deals tabs; it does not embed the standalone dashboard and it exposes no mutations.
