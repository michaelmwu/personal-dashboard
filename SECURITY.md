...
- Keep `FLIGHT_SEARCHER_OWNER_API_TOKEN` in the dashboard API process only. It authorizes human-verification screenshots and browser actions; web, worker, and Hermes processes need only the less-privileged service token.
